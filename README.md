<div align="center">
  <img src="public/logo.png" alt="Route of Sky Logo" width="180px" />
  <h1>Route of Sky</h1>
  <p><strong>뉴욕 타임스퀘어 상공의 3D 도시 경관과 실시간 날씨 데이터를 시각화하는 시뮬레이터</strong></p>
  ...
  <p>
    Cesium JS와 Google Photorealistic 3D Tiles를 결합하여 뉴욕 타임스퀘어 상공의 3D 도시 환경을 생생하게 구현하고,<br>
...
<div align="center">
  <img src="public/demo-1.gif" alt="Route of Sky Demo 1" width="49%" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.15);" />
  <img src="public/demo-2.gif" alt="Route of Sky Demo 2" width="49%" style="border-radius: 8px; box-shadow: 0 4px 15px rgba(0,0,0,0.15);" />
</div>

## ✨ 주요 기능

*   🌆 **Cesium 기반의 실사 3D 렌더링**
    *   Cesium Ion 토큰 연동 시 **Google Photorealistic 3D Tiles**를 로드하여 디테일한 뉴욕 타임스퀘어 전경 시각화.
...
*   ⛈️ **Weather Lab 기상 현상 구현**
    *   Cesium Particle System 및 Shader 효과를 커스텀하여 **구름, 비, 폭풍, 눈, 연무(Fog/Haze)** 비주얼 시뮬레이션 제공.
*   📊 **모던하고 직관적인 날씨 대시보드**
...
### 3. 환경 변수 설정
Google Photorealistic 3D Tiles를 사용하려면 **Cesium ion Access Token**이 필요합니다.
프로젝트 루트 폴더에 `.env` 파일을 생성하고 발급받은 액세스 토큰을 입력해 주세요.
...
```
> **Note**  
> Cesium ion 토큰이 없거나 잘못 설정되어 있더라도, 기본 Cesium 3D Globe 씬과 날씨 대시보드 오버레이 UI는 정상 작동하며, 화면 하단에 안내 메시지가 표시됩니다.
